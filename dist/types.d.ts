 ...
 */
export type InferredType = "integer" | "float" | "boolean" | "date" | "string" | "unknown";
/**
 ...
 * }
 */
export declare function isSchemaError(value: SchemaResult | SchemaError): value is SchemaError;
/**
 * Returns true if the value is a SchemaResult.
 */
export declare function isSchemaResult(value: SchemaResult | SchemaError): value is SchemaResult;
/**
